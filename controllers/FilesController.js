...
class FilesController {
   ...
   * If the type of the file document is folder, return an error A folder doesn'
   * have content
   * with a status code 400
   * If the file is not locally present, return an error Not found with a status
   * code 404
   * By  using the module mime-types, get the MIME-type based on the name of the
   * file
